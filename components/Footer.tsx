...
export default function Footer() {
	return (
		<footer className="w-full mt-24 bg-hatching-color border-t-2 border-[color-mix(in_srgb,var(--color-primary)_50%,transparent)] flex flex-row justify-center items-center">
			<div className="mt-6 py-4 pt-8 pb-16 px-8 bg-background rounded-t-3xl shadow-xs flex flex-col md:flex-row justify-center gap-8 md:gap-16 items-center">
				<div className="flex flex-row gap-4">
					...
					<a
						...
						target="_blank"
						rel="noopener noreferrer"
						aria-label="daily.dev profile (opens in new tab)"
						className="block bg-foreground p-2 rounded-lg aspect-square hover:bg-secondary focus-visible:bg-secondary transition-colors"
					>
						<InfinityIcon
							size={24}
